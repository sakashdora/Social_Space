    ...
    <div className="mx-auto max-w-3xl px-4 pb-28 lg:pb-10 pt-10 sm:px-6 lg:pt-14">
      ...
      <FrostedPanel className="p-6 mb-6">
        ...
        {totpQr && !isTotpEnabled && (
          ...
          >
            <p className="text-sm">
              Scan with your authenticator app, then enter a code to confirm:
            </p>
            <div className="flex justify-center">
              <img
                src={totpQr}
                alt="TOTP QR Code"
                className="h-44 w-44 rounded-xl border border-white/10 bg-white p-2"
              />
            </div>
            <div className="flex items-center gap-2">
              <input
      ...
      <FrostedPanel className="p-6 mb-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2 px-3 py-2.5 input-surface">
            <KeyRound className="h-4 w-4 text-muted-foreground shrink-0" />
            <label htmlFor="current-passphrase-change" className="sr-only">
              Current passphrase
            </label>
            <input
          ...
          <div className="flex items-center gap-2 px-3 py-2.5 input-surface">
            <KeyRound className="h-4 w-4 text-muted-foreground shrink-0" />
            <label htmlFor="new-passphrase-change" className="sr-only">
              New passphrase
            </label>
            <input
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-muted-foreground mt-0.5">
                      ...
                      {ev.deviceFingerprintHash && (
                        <span
                          className="ml-2 font-mono opacity-40 select-all"
                          title="Anonymised device fingerprint"
                        >
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 rounded-xl border border-white/10 py-2.5 text-sm text-muted-foreground hover:text-foreground transition"
                >
                  Cancel
                </button>
                <button
                ...
                <div className="relative z-10 p-8">
                  ...
                  <div className="mb-6 text-center space-y-3">
                    ...
                    <h3
                      ...
                      className="font-serif text-2xl text-foreground leading-tight"
                    >
                      Premium Membership
                    </h3>
                  ...
                  <div className="mb-6 grid grid-cols-2 gap-2">
                    {[
                      ...
                      <div
                        key={text}
                        className="flex items-center gap-2.5 rounded-xl border border-amber-500/10 bg-amber-500/[0.04] px-3 py-2.5"
                      >
